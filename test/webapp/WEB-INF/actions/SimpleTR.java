 ...
 */
public class SimpleTR extends GauceAction {
    ...
    public int insertUser(TxEvent event) {
    ...
    public int updateUser(TxEvent event) {
    ...
    public int deleteUser(TxEvent event) {
    ...
    public void destroy() {
        System.out.println("SimpleTR is being destroyed.");
    }
